...
import image from '../../assets/images/Whiskey-Wheat-Field.jpeg'
    ...
    return (
        <div>
            ...
            <div className={classes.loginButtonSection}>
                    <Button className={classes.loginButtonSection} variant='contained' color='default' style={{width:250,backgroundColor:'#7a4d22',marginTop:10,}} onClick={sign_out}>Sign Out</Button>
            </div>
            </div>
        </div>
    )
