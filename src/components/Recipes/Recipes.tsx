...
import image from '../../assets/images/chef_serving.jpeg'
...
export const Recipes = withRouter(( props:RecipesProps ) => {
    console.log(props);
    const { history } = props;
    ...
    return (
        <div className={`${classes.root} ${classes.column} ${classes.background}`}>
            ...
            <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}> {/* We are using MUI to make another navbar */} {/* clsx switches the classes depending 
                ...
                <Toolbar className={classes.toolbar}>
                    ...
                    <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                        <DialogTitle id="form-dialog-title">Add New Recipe For Your Book</DialogTitle>
                        <DialogContent>
            ...
            <main className={`${clsx(classes.content, {[classes.contentShift]: open,})} ${classes.leftMargin} ${classes.background}`}>
                <div className={classes.drawerHeader} />
                    <DataTable /> 
            </main>
        </div>
